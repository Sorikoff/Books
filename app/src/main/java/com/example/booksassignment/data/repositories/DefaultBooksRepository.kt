...
class DefaultBooksRepository : BooksRepository {
    ...
    override suspend fun getBooksLists(): CustomResult<List<BooksListModel>> {
        TODO("Not yet implemented")
    }

    override suspend fun getBooks(): CustomResult<List<BookModel>> {
        TODO("Not yet implemented")
    }

    override suspend fun getBook(id: Int): CustomResult<BookDetailsModel> {
        TODO("Not yet implemented")
    }
}

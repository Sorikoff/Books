...
object Constants {
    ...
    const val ROUTE_BOOKS_ID_TITLE = "$ROUTE_BOOKS/{$ROUTE_LIST_ID}/{$ROUTE_LIST_TITLE}"

    const val ROUTE_BOOK_ID = "ROUTE_BOOK_ID"
    const val ROUTE_BOOK_DETAILS = "ROUTE_BOOK_DETAILS"
    const val ROUTE_BOOK_DETAILS_LIST_ID = "$ROUTE_BOOK_DETAILS/{$ROUTE_BOOK_ID}"
}
